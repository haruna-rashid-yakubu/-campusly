    ...
    <Sheet open={open} onClose={() => setOpen(false)} title="Connecte-toi à Campusly">
      <div className="pb-1 text-center">
        <button
          ...
          className="press-scale mx-auto flex h-[54px] w-full max-w-xs items-center justify-center gap-2.5 rounded-2xl border-[1.5px] border-line-4 bg-white text-[15.5px] font-bold disabled:opacity-60 active:bg-surface-3"
        >
        ...
        <button
          ...
          className="mx-auto mt-2 h-11 px-4 text-[14px] font-bold text-slate-light"
        >
          Peut-être plus tard
        </button>
      </div>
